...
public class ToolListGenerator {
    ...
    public static List<Tool> getTools(ToolTab toolTab) {
        switch (toolTab.getToolType()) {
            ...
            case MORE:
            default:
                return getGenericToolList(R.drawable.hero_image_more_1080);
        }
    }
    ...
    private static List<Tool> getClamps(ToolTab toolTab) {
        ...
        return getGenericToolList(R.drawable.hero_image_clamps_1080);
    }
    ...
    private static List<Tool> getSaws(ToolTab toolTab) {
        ...
        return getGenericToolList(R.drawable.hero_image_saw_1080);
    }
    ...
    private static List<Tool> getDrills(ToolTab toolTab) {
        ...
        return getGenericToolList(R.drawable.hero_image_drill_1080);
    }

    private static List<Tool> getRouters(ToolTab toolTab) {
        final List<Tool> tools = new ArrayList<>();
        final String description = "";
        return getGenericToolList(R.drawable.hero_image_router_1080);
    }
    ...
    private static List<Tool> getSanders(ToolTab toolTab) {
        ...
        switch (toolTab.getStringResourceId()) {
            case R.string.stationary:
                tools.add(new Tool("Acme Spindle Sander", "$325", new String[] {"Spindle", "1/2 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                tools.add(new Tool("Couch Belt and Disc Sander", "$375", new String[] {"Belt/Disc", "3/4 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                tools.add(new Tool("Devil Spindle Sander", "$455", new String[] {"Spindle", "3/4 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                tools.add(new Tool("Devil Belt and Disc Sander", "$525", new String[] {"Belt/Disc", "1 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                tools.add(new Tool("Acme Disc Sander", "$555", new String[] {"Disc", "1 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                tools.add(new Tool("Bullet Spindle Sander", "$600", new String[] {"Spindle", "1 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                tools.add(new Tool("Couch Disc Sander", "$640", new String[] {"Disc", "1 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                tools.add(new Tool("Devil Drum Sander", "$700", new String[] {"Drum", "1.5 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                tools.add(new Tool("Acme Drum Sander", "$780", new String[] {"Drum", "2 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                tools.add(new Tool("Bullet Drum Sander", "$914", new String[] {"Drum", "2 HP"}, description, R.drawable.hero_image_sander_1080, R.drawable.thumbnail_sander_01));
                return tools;
        ...
        return getGenericToolList(R.drawable.hero_image_sander_1080);
    }
    ...
    private static List<Tool> getLathes(ToolTab toolTab) {
        ...
        tools.add(new Tool("Bacon Mini Lathe", "$325", new String[] {"1/2 HP", "10\" x 15\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        tools.add(new Tool("Dab Small Lathe", "$375", new String[] {"1/2 HP", "10\" x 20\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        tools.add(new Tool("Castle Lathe", "$455", new String[] {"3/4 HP", "12\" x 42\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        tools.add(new Tool("Dab Bench Lathe", "$525", new String[] {"3/4 HP", "12\" x 42\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        tools.add(new Tool("Acme Bench Lathe", "$555", new String[] {"1 HP", "14\" x 48\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        tools.add(new Tool("Dab Lathe and Stand", "$600", new String[] {"1 HP", "14\" x 48\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        tools.add(new Tool("Dab Variable Speed Lathe", "$640", new String[] {"1 HP", "14\" x 48\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        tools.add(new Tool("Acme Lathe", "$700", new String[] {"1 HP", "16\" x 56\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        tools.add(new Tool("Bacon 16\" x 56\" Lathe", "$780", new String[] {"1 HP", "16\" x 56\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        tools.add(new Tool("Castle Extended Lathe", "$914", new String[] {"2 HP", "20\" x 80\""}, description, R.drawable.hero_image_lathe_1080, R.drawable.thumbnail_lathe_01));
        return tools;
    }
